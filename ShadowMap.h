...
private:
	...
	CD3DX12_CPU_DESCRIPTOR_HANDLE mhCpuSrv[12];
	CD3DX12_GPU_DESCRIPTOR_HANDLE mhGpuSrv[12];
	CD3DX12_CPU_DESCRIPTOR_HANDLE mhCpuDsv[12];

	Microsoft::WRL::ComPtr<ID3D12Resource> mShadowMap[12];
};